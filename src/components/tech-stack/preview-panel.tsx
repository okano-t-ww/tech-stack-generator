...
export const PreviewPanel = ({
  ...
  return (
    <div className="xl:col-span-5 space-y-2">
      ...
      <div className="min-h-100 p-4 border-2 border-dashed border-border/50 rounded-xl bg-linear-to-b from-muted/20 to-transparent">
        <TechIconGrid
      ...
      >
        ...
        <div className="absolute inset-0 bg-linear-to-r from-primary/0 via-primary/20 to-primary/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      </Button>
    </div>
  );
};
